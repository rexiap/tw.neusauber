...
.. |STYLE2| replace:: **五種適用面：金屬面、鏽蝕面、油漆面、高熱面、低溫面**

.. |STYLE3| replace:: **七項優勢：用量省、免技巧、不挑漆、無膜厚、全透明、超環保、效果長**

.. |STYLE4| replace:: **型號：ARPrimer M3100 底塗型透明防鏽劑 專業級1號**

.. |STYLE5| replace:: **型號：ARSealing M3300 密封型透明防鏽劑 專業級3號**
